...
<head runat="server">
    ...
    <style>
        ...
        .auto-style5 { text-decoration: underline; font-size: large; }
        ...
        .auto-style6 { position: absolute; top: 94px; left: 838px; z-index: 1; }
        .auto-style7 { position: absolute; top: 94px; left: 838px; z-index: 1; bottom: 435px; }
        .auto-style8 { position: absolute; top: 152px; left: 839px; }
        .auto-style9 { position: absolute; top: 232px; left: 839px; }
    </style>
</head>
<body>
                ...
                <table>
                    <tr>
                        <td class="auto-style4">
                            <input placeholder="Title (The maximum number of characters is 50)" maxlength="50" runat="server" id="txtTiteTask" class="auto-style3 inpuTtitleStyle" />
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <textarea placeholder="Supject (The maximum number of characters is 500)" maxlength="500" runat="server" id="txtSubjectTask" class="auto-style2 subjectStyle"></textarea>
                        </td>
                        <td>
                            ...
                            <asp:RequiredFieldValidator
                                ...
                                runat="server"
                                ControlToValidate="txtSubjectTask"
                                ErrorMessage="*"
                                ForeColor="Red"
                                Style="z-index: 1">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator
                                ...
                                runat="server" ControlToValidate="GetCurUsers1"
                                ErrorMessage="*"
                                Style="z-index: 1">
